...
/**
 * Basic controller for health checks and documentation redirects.
 */
@RestController
...
public class HelloController {
    ...
    public String hello() {
        return "Hello, Spring Boot! Welcome to productsapibackend - Products API";
    }
    ...
    public String info() {
        return "Spring Boot Application: productsapibackend - Products API v1.0.0";
    }
}
